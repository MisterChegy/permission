    ...
    $('#grid').datagrid({
        ...
        toolbar: [{
            ...
            handler: function () {
                ...
                // {
                //     debitids[i] = selections[i].debitid;
                // }
                // console.log("debitids = "+ debitids);
                // delSelections(debitids.toString());
                del(selected);
            }
        }, '-', {
            text: '导出',
 ...
 * 多行删除
 */
function delSelections(selections) {
    $.messager.confirm("确认", "确认要删除吗？", function (yes) {
        if (yes) {
            $.ajax({
                url: name + 'deleteByIds',
                data: selections,
                dataType: 'json',
                type: 'post',
                success: function (rtn) {
